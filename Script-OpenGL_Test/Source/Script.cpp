...
void Script::render() {
	...
	RENDER::Dim_2D::RoundedLine(F32_V2(60, 60), F32_V2(-60, 60), 4, u_color);

	RENDER::Dim_2D::RoundedLine(F32_V2(  60, 60), F32_V2( 100, 20), 4, u_color);
	RENDER::Dim_2D::RoundedLine(F32_V2( -60, 60), F32_V2(-100, 20), 4, u_color);

	RENDER::Dim_2D::RoundedLine(F32_V2( 100, 20), F32_V2( 160, 10), 4, u_color);
	RENDER::Dim_2D::RoundedLine(F32_V2(-100, 20), F32_V2(-160, 10), 4, u_color);

	RENDER::Dim_2D::RoundedLine(F32_V2( 160, 10), F32_V2( 170, -40), 4, u_color);
	RENDER::Dim_2D::RoundedLine(F32_V2(-160, 10), F32_V2(-170, -40), 4, u_color);

	RENDER::Dim_2D::RoundedLine(F32_V2( 170, -40), F32_V2( 130, -40), 4, u_color);
	RENDER::Dim_2D::RoundedLine(F32_V2(-170, -40), F32_V2(-130, -40), 4, u_color);

	RENDER::Dim_2D::RoundedLine(F32_V2(30, -40), F32_V2(-30, -40), 4, u_color);
